...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("vpn1_users");
}
...
class tDAL
{
	var $tblvpn_at_s10086_vip__user;
	var $tblvpn_at_s10086_vip__vpn1_users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "user", "varname" => "vpn_at_s10086_vip__user", "altvarname" => "user", "connId" => "vpn_at_s10086_vip", "schema" => "", "connName" => "vpn at s10086.vip");
		$this->lstTables[] = array("name" => "vpn1_users", "varname" => "vpn_at_s10086_vip__vpn1_users", "altvarname" => "vpn1_users", "connId" => "vpn_at_s10086_vip", "schema" => "", "connName" => "vpn at s10086.vip");
	}
