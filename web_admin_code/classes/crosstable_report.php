...
class CrossTableReport
{
	...
	{					
		...
		return "X 组 提示的字段的列表。用户应选择字段，该字段将会显示在交叉分析报表中水平哪些值。"
			.":<b>".$this->xml_array["totals"][ $fieldNameX ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Y 组 提示的字段的列表。用户应选择字段，该字段将会显示在交叉分析报表中垂直哪些值。"
			.":<b>".$this->xml_array["totals"][ $fieldNameY ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."字段 提示的字段的列表。用户应选择字段，该字段将会显示在交叉分析报表中的网格内哪些值。"
			.":<b>".$this->xml_array["totals"][ $fieldName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."组函数 交叉分析报表中的聚合函数的列表的提示。在列表中的功能是笔、最小、最大、 AVG "
