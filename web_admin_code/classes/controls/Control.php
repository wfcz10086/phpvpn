...
class EditControl
{
	...
	function EditControl($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[CONTAINS] = "包含";
		$this->searchOptions[EQUALS] = "等于";
		$this->searchOptions[STARTS_WITH] = "以。。。。。。开始";
		$this->searchOptions[MORE_THAN] = "多于．．．．．．";
		$this->searchOptions[LESS_THAN] = "少于．．．．．．";
		$this->searchOptions[BETWEEN] = "在 --- 中间";
		$this->searchOptions[EMPTY_SEARCH] = "空格";
		$this->searchOptions[NOT_CONTAINS] = "不包含 键入搜索条件。成分不包含脂肪";
		$this->searchOptions[NOT_EQUALS] = "不等于 键入搜索条件。宠物不等于猫";
		$this->searchOptions[NOT_STARTS_WITH] = "不会开始 键入搜索条件。名称不会启动与A";
		$this->searchOptions[NOT_MORE_THAN] = "是不能超过 键入搜索条件。Horsepowers是不能超过200";
		$this->searchOptions[NOT_LESS_THAN] = "是不小于 键入搜索条件。Horsepowers是不小于200";
		$this->searchOptions[NOT_BETWEEN] = "不介于 键入搜索条件。重量不介于50 和 100";
		$this->searchOptions[NOT_EMPTY] = "不是空的 键入搜索条件。利益，不为空";
