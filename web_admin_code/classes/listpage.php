...
{	
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\""."跳到表数据 若要跳转到表中的数据记录，热键"."\" class=\"".$this->makeClassName("s508")."\">"."跳到表数据 若要跳转到表中的数据记录，热键"."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."跳转到菜单 跳转到菜单的热键"."\" class=\"".$this->makeClassName("s508")."\">"."跳转到菜单 跳转到菜单的热键"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."跳到搜索 跳至搜索表单的热键"."\" class=\"".$this->makeClassName("s508")."\">"."跳到搜索 跳至搜索表单的热键"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."热键参考 应用热键列表的"."\" class=\"".$this->makeClassName("s508")."\">"."热键参考 应用热键列表的"."</a>";
		}
